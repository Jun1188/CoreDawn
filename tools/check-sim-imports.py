...
규칙
  Assets/Scripts/Sim/**                  : CoreDawn.Sim 외의 CoreDawn.* import 금지
  Assets/Scripts/Game/Factory/** (심 파일): CoreDawn.Entities import 금지 (뷰 타입)
...
ROOT = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'Assets', 'Scripts')
...
scan(os.path.join(ROOT, 'Game', 'Factory'), forbidden=FACTORY_FORBIDDEN, skip=FACTORY_BRIDGES)
